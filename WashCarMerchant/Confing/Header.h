...
//  Copyright © 2016年 kevll. All rights reserved.
//
...
#define APPColor RGB_COLOR(70, 210, 210)
#define BG_COLOR_View RGB_COLOR(224, 225, 226)
#define TextColor RGB_COLOR(50, 50, 50)

#define WSLFontSys(_size) [UIFont systemFontOfSize:_size]

#define HeiTiSize(_size) WSLFontSys(_size/2)//[UIFont fontWithName:@"STHeitiSC-Light" size:(sz)/2]
...
#define kAppThemeColor [UIColor colorWithRed:252/255.0 green:102/255.0 blue:33/255.0 alpha:1]
#define kSepLineColor       [UIColor colorWithHexString:@"E7E7E7"]
...
#define kFailPromptStr @"服务器开小差了,请稍后重试"

#define kAPPDownloadPageUrl @"http://tunjifen.com/appDownload.html"

#define kColor_Yellow RGB_COLOR(245, 172, 45)

#define kIsZd   [kUserDefault objectForKey:@"isZd"]
#define kShopId [kUserDefault objectForKey:@"shopId"]
