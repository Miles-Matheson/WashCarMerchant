...
@interface YKPushManager () <JPUSHRegisterDelegate>
...
{
    static YKPushManager *_instance;
...
- (void)initJPUSH:(NSDictionary *)launchOptions{
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"11b5a00c8fd1e08c517f0ce0"channel:@"Apple Store"apsForProduction:YES
           ];
}
